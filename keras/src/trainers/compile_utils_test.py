...
class TestCompileMetrics(testing.TestCase):
    ...
    def test_dict_outputs_uses_output_names(self):
        """Tests that when output_names that match the metrics dict keys, those
        are used to name the metrics."""
        ...
        self.assertIn("dense_1_mean_squared_error", result)
        self.assertIn("dense_2_mean_squared_error", result)
    ...
    def test_dict_outputs_output_names_ordering(self):
        ...
        self.assertIn("dense_1_mean_squared_error", result)
        self.assertIn("dense_2_mean_absolute_percentage_error", result)
    ...
    def test_dict_outputs_outputs_ordering(self):
        ...
        self.assertIn("b_mean_absolute_percentage_error", result)
    ...
    def test_deeply_nested_outputs_and_metrics(self):
        ...
        self.assertIn("mse_a", result)
        self.assertIn("mse_c", result)
        self.assertIn("mse_d1", result)
        self.assertIn("mse_d2", result)
